                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" ng-model="Basic"
                                                            autocomplete="off" ng-model-options='{ debounce: 1000 }'
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" ng-model="LWF"
                                                            autocomplete="off" onkeypress="return Validate(event);">
                                                    </div>
                                                                                ...
                                                                                <div class="col-lg-7"
                                                                                    ...
                                                                                    <table class="britannia-idcard">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div id='Empfront'>
                                                                                                    <img class="britannia-id-bg"
                                                                                                        src="img/front1.jpg">

                                                                                                    <div
                                                                                                        class="britannia-id-front-info">
