            ...
            <div id="myCarousel" class="carousel slide" data-interval="false">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="card">
                            <h5 class="card-header text-green" style="margin-top:10px">Employee Details</h5>
                    ...
                    <div class="carousel-item">
                        ...
                        <h5 class="card-header text-green" style="margin-top:10px">Employee Modification</h5>
                        <div class="card-body">
