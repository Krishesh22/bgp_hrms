...
if (isset($_FILES['files']) && !empty($_FILES['files'])) {
    ...
    $directory4 = "../$Folderid/$EMPCHECKLIST/";

      $directory3 = "../$Folderid/EMPCHECKLIST/";
    $directory2 = "../$Folderid/EMPCHECKLIST/$Employeeid/";
    $directory = "../$Folderid/EMPCHECKLIST/$Employeeid/$Sno/";
