        ...
        <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM10Controller">
            <div class="">
                ...
                <div class="container-fluid dashboard-content">
                    <div class="mt-3">
                        <h5 class="text-green">Employee Creation</h5>
                        <hr/>
                        <div class="">
                            <div class="row">
                                ...
                                <div class="text-right" style="margin-top:18px">
                                    ...
                                    <button class=" btn btn-sm btn-primary" ng-click="Update_Major();"
                                        ng-show="btnupdate">Update</button>
                                    <button class="btn btn-sm  btn-danger " ng-click="Reset();">Reset</button>
                                </div>
