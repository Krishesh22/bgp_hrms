...
?>
     ...
     ' href='#' data-toggle='collapse' aria-expanded='false' data-target='#submenu-2' aria-controls='submenu-2'><i
                    ...
                    <a class='nav-link <?=($cpage == 'adddailyattendancebgp') ? 'active' : '' ?>'
                        title='Daily Attendance' href='<?=$domain ?>/HRM16/AddDailyattendanceBGP.php'><i
                            class='fa fa-address-book'></i> Attendance Delhi</a>
                </li>
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'leaveattendancedetails') ? 'active' : '' ?>'
                        title='Attendance form' href='<?=$domain ?>/HRM14/LeaveAttendanceDetails.php'><i
                            class='fa fa-address-book'></i>Form-12 & 25</a>

                </li>
                <li class='nav-item'>
            <a class='nav-link <?=($cpage=='employeeleavesummaryupload')?'active':''?>' title='Daily Attendance' href='<?=$domain?>/HRM39/Employeeleavesummaryupload.php'><i class='fa fa-address-book'></i> Leave Summary Upload</a>
            </li>
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'monthlyattendanceclose') ? 'active' : '' ?>'
                        title='Daily Attendance' href='<?=$domain ?>/HRM16/Monthlyattendanceclose.php'><i
                            class='fa fa-address-book'></i> Close Attendance</a>
                </li>
                <?php
             } else {?>
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'adddailyattendance') ? 'active' : '' ?>' title='Daily Attendance'
                        href='<?=$domain ?>/HRM16/AddDailyattendance.php'><i class='fa fa-address-book'></i>
                        Attendance</a>
                </li>
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'attendance_details') ? 'active' : '' ?>' title='Attendance form'
                        href='<?=$domain ?>/HRM14/attendance_details.php'><i class='fa fa-address-book'></i>Form-12 &
                        25</a>
                ...
                <?php } ?>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'employeedailyattandancerpt') ? 'active' : '' ?>'
                                            ...
                                            href='<?=$domain ?>/HRM37/EmployeeDailyattandancerpt.php'><i
                                                class='fa fa-address-book'></i> Attendance Report</a>
                                    </li>
                                 
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'addpayrolltemp') ? 'active' : '' ?>'
                                            title='Payroll Temp' href='<?=$domain ?>/HRM14/AddPayrolltemp.php'><i
                                                class='fa fa-id-card'></i> Payroll </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'employeepayrolldeduction') ? 'active' : '' ?>'
                                            title='Deduction Upload'
                                            href='<?=$domain ?>/HRM14/Employeepayrolldeduction.php'><i
                                                class='fa fa-id-card'></i> Deduction Upload </a>
                                    </li>

                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'empesidetails') ? 'active' : '' ?>'
                                            title='Employee ESI Detail' href='<?=$domain ?>/HRM14/Empesidetails.php'><i
                                                class='fa fa-id-card'></i> Employee ESI List </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'emppayrolldeductionlist') ? 'active' : '' ?>'
                                            title='Deduction List'
                                            href='<?=$domain ?>/HRM14/Emppayrolldeductionlist.php'><i
                                                class='fa fa-id-card'></i> Deduction List </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'payrollclose') ? 'active' : '' ?>'
                                            title='Payslip' href='<?=$domain ?>/HRM14/Payrollclose.php'><i
                                                class='fa fa-id-card'></i> Payslip </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'payrollrpt') ? 'active' : '' ?>'
                                            title='Categorywise Payrol' href='<?=$domain ?>/HRM14/PayrollRpt.php'><i
                                                class='fa fa-id-card'></i> Categorywise Payroll </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'bankpayroll') ? 'active' : '' ?>'
                                            title='Bank Report' href='<?=$domain ?>/HRM14/Bankpayroll.php'><i
                                                class='fa fa-id-card'></i> Bank Report </a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link <?=($cpage == 'categorywise_attendanceview') ? 'active' : '' ?>'
                                            title='Categorywise-Attendance details'
                                            href='<?=$domain ?>/HRM14/Categorywise_attendanceview.php'><i
                                                class='fa fa-id-card'></i> Categorywise-Attendance details </a>
                                    </li>
                        </li>
                        <li class='nav-item'>
                            <a class='nav-link <?=($cpage == 'categorywise_attendanceviewnew') ? 'active' : '' ?>'
                                title='Categorywise-Actual Attendance details'
                                href='<?=$domain ?>/HRM14/Categorywise_attendanceviewNew.php'><i
                                    class='fa fa-id-card'></i> Categorywise- Actual Attendance details </a>
                        </li>
                        <li class='nav-item'>
                            <a class='nav-link <?=($cpage == 'categorywise_payslip') ? 'active' : '' ?>'
                                title='Categorywise-Bulk Payslip' href='<?=$domain ?>/HRM14/Categorywise_payslip.php'><i
                                    class='fa fa-id-card'></i> Categorywise-Bulk Payslip </a>
                        </li>
                </ul>
            </div>
            </li>
    ...
    <ul class='navbar-nav flex-column'>
        ...
        <li class='nav-item'>
            <a class='nav-link <?=($cpage == 'adddailyattendance' || $cpage == 'employeedailyattandancerpt' || $cpage == 'addpayrolltemp' || $cpage == 'employeepayrolldeduction' || $cpage == 'empesidetails' || $cpage == 'emppayrolldeductionlist' || $cpage == 'payrollclose' || $cpage == 'payrollrpt' || $cpage == 'bankpayroll' || $cpage == 'categorywise_attendanceview' || $cpage == 'categorywise_payslip') ? 'active' : '' ?>'
                href='#' data-toggle='collapse' aria-expanded='false' data-target='#submenu-5'
                aria-controls='submenu-5'><i class='fa fa-balance-scale'></i>Payroll</a>
            <div id='submenu-5'
                class='collapse submenu <?=($cpage == 'adddailyattendance' || $cpage == 'employeedailyattandancerpt' || $cpage == 'addpayrolltemp' || $cpage == 'employeepayrolldeduction' || $cpage == 'empesidetails' || $cpage == 'emppayrolldeductionlist' || $cpage == 'payrollclose' || $cpage == 'payrollrpt' || $cpage == 'bankpayroll' || $cpage == 'leaveattendancedetails' || $cpage == 'adddailyattendancebgp' || $cpage == 'Monthlyattendanceclose' || $cpage == 'categorywise_attendanceview' || $cpage == 'categorywise_payslip') ? 'show' : '' ?>'>
                <ul class='nav flex-column'>
                    <?php if ($Clientid == 4) {
?><li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'adddailyattendancebgp') ? 'active' : '' ?>'
...
?>
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'adddailyattendance') ? 'active' : '' ?>'
                            title='Daily Attendance' href='<?=$domain ?>/HRM16/AddDailyattendance.php'><i
                                class='fa fa-address-book'></i> Attendance</a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'attendance_details') ? 'active' : '' ?>'
                            title='Attendance form' href='<?=$domain ?>/HRM14/attendance_details.php'><i
                                class='fa fa-address-book'></i>Form-12 & 25</a>
                    ...
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'employeedailyattandancerpt') ? 'active' : '' ?>'
                            title='Daily Attendance' href='<?=$domain ?>/HRM37/EmployeeDailyattandancerpt.php'><i
                                class='fa fa-address-book'></i> Attendance Report</a>
                    </li>
                    <li class='nav-item'>
                    ...
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'employeepayrolldeduction') ? 'active' : '' ?>'
                            title='Deduction Upload' href='<?=$domain ?>/HRM14/Employeepayrolldeduction.php'><i
                                class='fa fa-id-card'></i> Deduction Upload </a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'emppayrolldeductionlist') ? 'active' : '' ?>'
                            title='Deduction List' href='<?=$domain ?>/HRM14/Emppayrolldeductionlist.php'><i
                                class='fa fa-id-card'></i> Deduction List </a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'empesidetails') ? 'active' : '' ?>'
                    ...
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'payrollrpt') ? 'active' : '' ?>' title='Payslip'
                            href='<?=$domain ?>/HRM14/PayrollRpt.php'><i class='fa fa-id-card'></i> Categorywise Payroll
                        </a>
                    </li>
                    <li class='nav-item'>
                    ...
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'categorywise_attendanceview') ? 'active' : '' ?>'
                            title='Payslip' href='<?=$domain ?>/HRM14/Categorywise_attendanceview.php'><i
                                class='fa fa-id-card'></i> Categorywise Attendance details </a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'categorywise_payslip') ? 'active' : '' ?>' title='Payslip'
                            href='<?=$domain ?>/HRM14/Categorywise_payslip.php'><i class='fa fa-id-card'></i>
    ...
    <ul class='navbar-nav flex-column'>
        ...
        <li class='nav-item'>
            <a class='nav-link <?=($cpage == 'adddailyattendance' || $cpage == 'employeedailyattandancerpt' || $cpage == 'addpayrolltemp' || $cpage == 'employeepayrolldeduction' || $cpage == 'empesidetails' || $cpage == 'emppayrolldeductionlist' || $cpage == 'payrollclose' || $cpage == 'payrollrpt' || $cpage == 'bankpayroll' || $cpage == 'categorywise_attendanceview' || $cpage == 'categorywise_payslip' || $cpage == 'attendance_details') ? 'active' : '' ?>'
                ...
                aria-controls='submenu-5'><i class='fa fa-balance-scale'></i>Payroll</a>
            <div id='submenu-5'
                class='collapse submenu <?=($cpage == 'adddailyattendance' || $cpage == 'employeedailyattandancerpt' || $cpage == 'addpayrolltemp' || $cpage == 'employeepayrolldeduction' || $cpage == 'empesidetails' || $cpage == 'emppayrolldeductionlist' || $cpage == 'payrollclose' || $cpage == 'payrollrpt' || $cpage == 'bankpayroll' || $cpage == 'leaveattendancedetails' || $cpage == 'adddailyattendancebgp' || $cpage == 'Monthlyattendanceclose' || $cpage == 'categorywise_attendanceview' || $cpage == 'categorywise_payslip' || $cpage == 'attendance_details') ? 'show' : '' ?>'>
                <ul class='nav flex-column'>
                    <?php if ($Clientid == 4) {?> 
                  <li class='nav-item'>
                        <a class='nav-link <?=($cpage == 'adddailyattendancebgp') ? 'active' : '' ?>'
                    ...
                    <li class='nav-item'>
                        ...
                        <a class='nav-link <?=($cpage == 'attendance_details') ? 'active' : '' ?>'
                            title='Attendance form' href='<?=$domain ?>/HRM14/attendance_details.php'><i
                                class='fa fa-address-book'></i>Attendance Form</a>
        ...
        <li class='nav-item'>
            <a class='nav-link <?=($cpage == 'categorywise_attendanceview') ? 'active' : '' ?>' title='Payslip'
                href='<?=$domain ?>/HRM14/Categorywise_attendanceview.php'><i class='fa fa-id-card'></i>
                Categorywise-Attendance details </a>
        </li>
        <li class='nav-item'>
            <a class='nav-link <?=($cpage == 'categorywise_payslip') ? 'active' : '' ?>' title='Payslip'
                href='<?=$domain ?>/HRM14/Categorywise_payslip.php'><i class='fa fa-id-card'></i> Categorywise-Bulk
                Payslip </a>
        </li>
    </ul>
</div>
            ...
            <a class='nav-link <?=($cpage=='employeeleavesummaryupload')?'active':''?>' title='Daily Attendance' href='<?=$domain?>/HRM39/Employeeleavesummaryupload.php'><i class='fa fa-address-book'></i> Leave Summary Upload</a>
                ...
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'empesidetails') ? 'active' : '' ?>' title='Employee ESI Detail'
                        href='<?=$domain ?>/HRM14/Empesidetails.php'><i class='fa fa-id-card'></i> Employee ESI List
                    </a>
                </li>
                <li class='nav-item'>
                    <a class='nav-link <?=($cpage == 'emppayrolldeductionlist') ? 'active' : '' ?>'
