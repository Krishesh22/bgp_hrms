...
//echo "$Employeeid <br>";
     ...
     $resultExists = "Update indsys1030empyearleavetakensummary set 
         
            Fullname ='$Fullname',
            Userid='$user_id',
            Addormodifydatetime ='$date',
            CausalleaveEligibility ='$EligibilityCL',
            UsedCasualleave ='$UsedCL',
            BalanceCausalLeave='$BalanceCL',
            SickleaveEligibility ='$EligibilitySL',
            UsedSickLeave ='$UsedSL',
            BalanceSickLeave ='$BalanceSL',
            SickleaveEligibilityYesorNo='$ESI_Yesandno',
            TotalPresentdays ='0'
           
            
               WHERE Employeeid = '$Employeeid' AND Clientid ='$Clientid' AND AttendenceYear='$Attendanceyear' ";
            $resultExists01 = $conn->query($resultExists);
 ...
 //echo "$resultExists <br>";
    ...
    else
    {
      ...
      '$UsedCL','$BalanceCL','$EligibilitySL','$UsedSL',' $BalanceSL','$ESI_Yesandno','0')";   
