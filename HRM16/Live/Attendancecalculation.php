...
function CalculateCLSL($conn, $Clientid, $Employeeid, $AttenStatus, $Attendencedate, $user_id) {
    try {
        ...
        $GetCurrentYearLeavestatus = "SELECT * FROM indsys1030empmonthleavetakenmastersummary where Clientid ='$Clientid' and Employeeid='$Employeeid' and AttendenceYear='$Attendanceyear' And AttendenceMonth!='$Attendancemonth'  and Leavestatus='Open' LIMIT 1";
