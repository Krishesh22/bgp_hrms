        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-wrapper" ng-App="MyApp" ng-controller="HRM16Controller">
                ...
                <div class="container-fluid dashboard-content">
                    ...
                    <div class="mt-3">
                        <div class="">
                            <h5 class="">Daily Attendance Detail</h5><hr/>
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <input type="text" class="form-control" ng-model="NoofPresents"
                                            autocomplete="off" readonly>
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label class="col-form-label">Absents</label>
                                        <input type="text" class="form-control" ng-model="NoofAbsents"
                                            autocomplete="off" readonly>
                                    </div>
                                    <div class="form-group col-md-1">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" ng-model="NoofEmployee"
                                            autocomplete="off" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <input type="text" class="form-control" ng-model="Adminapproval"
                                            autocomplete="off" readonly>
                                    </div>
                                    <div class="form-group text-right" style="margin-top: 19px;">
                                    ...
                                    <div class="col-md-12">
                                        <span style="color:red">Note: Invalid or
                                            mismatched
                            ...
                            <div class="">
                                <h5 class="text-green">Employee Attendance Daily Detail</h5>
                                        ...
                                        <div class="wrapper">
                                            <table class="table table-bordered  " style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr dir-paginate="e in GetEmpDailyAttendanceList |filter:searchHoliday | itemsPerPage:10 | orderBy: 'Employeeid' track by $index  "
                                                        ...
                                                        current-page="currentPageEmpAttendance" ng-class="{ 'rowcolormissmatched': e.Mismatchedattendence === 'Yes','rowcoloreditmatched': e.OT_HRS >= 1.10,'rowcolorbreakmatched': e.Empbreakpunchfound === 'Yes'}">
                                                        <td style="width: 25px;">
                                                        ...
                                                        <td ng-show="btnOpen">
                                                            ...
                                                            <select class="form-control" style="width:50px;"
                                                                ...
                                                                <option ng-repeat="s in GetdailyattenstatusList "
                                                                    value="{{s.AttenStatus}}">
                                                                    {{s.AttenStatus}}
                                                                </option>
                                                        ...
                                                        <td ng-show="btnOpen"><input class="form-control"
                                                        ...
                                                        <td ng-show="btnOpen">
                                                            <input class="form-control" onfocus="(this.type='time')"
                                                                step="2" onblur="(this.type='text')"
                                                                ng-model="e.Outtime" placeholder="HH:mm:ss"
                                                                style="width:120px;"
                                                                ng-model-options='{ debounce: 1500 }'
                                                        ...
                                                        <td ng-show="btnOpen">
                                                            <input class="form-control" onfocus="(this.type='time')"
                                                                step="2" onblur="(this.type='text')"
                                                                ng-model="e.OTIntime" placeholder="HH:mm:ss"
                                                                style="width:120px;"
                                                                ng-model-options='{ debounce:1500 }'
                                                        ...
                                                        <td ng-show="btnOpen">
                                                            <input class="form-control" onfocus="(this.type='time')"
                                                                step="2" onblur="(this.type='text')"
                                                                ng-model="e.OTOuttime" placeholder="HH:mm:ss"
                                                                style="width:120px;"
                                                                ng-model-options='{ debounce: 1500 }'
                                            ...
                                            <div class="float-right mt-2">
                                                <div class="pagination ">
                                                    <dir-pagination-controls pagination-id="EmpAttendancegrid"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-danger">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="col-form-label">Attendance Date</label>
                                                        <input class="form-control" ng-model="AttendanceDate"
                                                            readonly />
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="col-form-label">Attendance Status</label>
                                                        <input class="form-control" ng-model="Atendancestatus"
                                                            readonly />
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="BreakIntime"
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="BreakOuttime"
                                                            placeholder="HH:mm:ss" ng-model-options='{ debounce: 1500 }'
                                                            ng-change="GetDurationOutHours(BreakIntime,BreakOuttime,AttendanceDate,Employeeid);" />
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="col-form-label">Duration</label>
                                                        <input class="form-control" ng-model="Takenbreakhours"
                                                            readonly />
                                                    </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-danger" role="alert">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 nopadding">
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="Intime"
                                                            placeholder="HH:mm:ss" ng-model-options='{ debounce: 1500 }'
                                                            ng-change="CalculateOTTime(Employeeid,Attendencedate,AttenStatus,Intime,Outtime,OTIntime,OTOuttime,Allowotyesorno,Permissionyesorno)" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 nopadding">
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="Outtime"
                                                            placeholder="HH:mm:ss" ng-model-options='{ debounce: 1500 }'
                                                            ng-change="CalculateOTTime(Employeeid,Attendencedate,AttenStatus,Intime,Outtime,OTIntime,OTOuttime,Allowotyesorno,Permissionyesorno)" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 nopadding">
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="OTIntime"
                                                            placeholder="HH:mm:ss" ng-model-options='{ debounce: 1500 }'
                                                            ng-change="CalculateOTTime(Employeeid,Attendencedate,AttenStatus,Intime,Outtime,OTIntime,OTOuttime,Allowotyesorno,Permissionyesorno)" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 nopadding">
                                                        <input class="form-control" onfocus="(this.type='time')"
                                                            step="2" onblur="(this.type='text')" ng-model="OTOuttime"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 nopadding">
                                                        <input class="form-control" ng-model="Allowotyesorno"
                                                            readonly />
                                                    </div>
                                                </div>
