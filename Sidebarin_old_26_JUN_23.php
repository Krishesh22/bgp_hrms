     ...
     ' href='#' data-toggle='collapse' aria-expanded='false' data-target='#submenu-2' aria-controls='submenu-2'><i
                        ...
                        <li class='nav-item'>
                            <a class='nav-link <?=($cpage == 'categorywise_attendanceviewnew') ? 'active' : '' ?>'
                                ...
                                href='<?=$domain ?>/HRM14/Categorywise_attendanceviewNew.php'> Categorywise- Actual
                                Attendance details </a>
                        </li>
                        <li class='nav-item'>
                            <a class='nav-link <?=($cpage == 'categorywise_payslip') ? 'active' : '' ?>'
                                title='Categorywise-Bulk Payslip' href='<?=$domain ?>/HRM14/Categorywise_payslip.php'>  Categorywise-Bulk Payslip </a>
                        </li>
                </ul>
            </div>
            </li>
...
<li class='nav-item '>
    <a class='nav-link animate-charcter <?=($cpage=='cat3dashboard')?'active':''?>' href='<?=$domain?>/cat3dashboard.php'><i
...
<li class='nav-item'>
    <a class='nav-link <?=($cpage=='jobCat3view')?'active':''?>' href='#' data-toggle='collapse' aria-expanded='false'
        data-target='#submenu-1' aria-controls='submenu-1'><i class='fa fa-sticky-note'></i>Job
        Application</a>
...
<li class='nav-item'>
    <a class='nav-link <?=($cpage=='Cat3Candidate')?'active':''?>' href='#' data-toggle='collapse' aria-expanded='false'
        data-target='#submenu-2' aria-controls='submenu-2'><i class='fa fa-users'></i>Candidate</a>
...
<a class='nav-link <?=( $cpage=='Cat3viewEmployee')?'active':''?>' href='#' data-toggle='collapse' aria-expanded='false'

    data-target='#submenu-3' aria-controls='submenu-3'><i class='fa fa-user'></i>Employee</a>
...
<li class='nav-item '>
    <a class='nav-link <?=( $cpage=='ViewDocumentMaster')?'active':''?>' href='#' data-toggle='collapse' aria-expanded='false'
        data-target='#submenu-4' aria-controls='submenu-4'><i class='fa fa-user'></i>Document</a>
