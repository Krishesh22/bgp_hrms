...
$logempbreakhrs = "SELECT * FROM indsys1026employeepayrollmastertemp where SalMonth='$Payrollmonth' and Salyear='$Payrollyear' AND Category in(". $Categoryarray.") AND Clientid='$Clientid'";
	// echo $logempbreakhrs;
