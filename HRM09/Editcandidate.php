                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" ng-model="Candidateid"
                                                autocomplete="off" id="Candidateid" name ="Candidateid" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" ng-model="Contactno"
                                                ...
                                                ng-change="GetContactnounique(Contactno)" readonly>
                                    ...
                                    <div class="tab-content">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <label class="col-form-label">Reporting
                                                                    To</label>
                                                                <select ng-model="ReportingToid" class="form-control"  ng-show="Category !='Category 1'"
                                                                ...
                                                                <select ng-model="ReportingToid" class="form-control" ng-show="Category =='Category 1'"
                                                                    ...
                                                                    <option ng-repeat="s in GetuserList "
                                                                        value="{{s.Userid}}">
                                                                        {{s.Title}}
                                                                        {{s.Username}}
                                                                    </option>
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select ng-model="Location" class="form-control">
                                                                    ...
                                                                    <option ng-repeat="s in GetCityListLocation "
                                                                        value="{{s.City}}">
                                                                        {{s.City}}</option>
                                                                </select>
                                                            </div>
                                        ...
                                        <div id="menu2" class="tab-pane fade">
                                            <div class="noshadow">
                                                ...
                                                <h5 class="text-green mt-2 pl-0">Previous(Britannia) Employee Details
                                                </h5>
                                                <hr />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3" ng-show="btnpreviousworked">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ng-model="Releivingreason" autocomplete="off" readonly>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label class="col-form-label">HR
                                                            (Interview)</label>
                                                        <input type="text" class="form-control"
                                                            ng-model="Interview_held_On" onfocus="(this.type='date')"
                                                            onblur="(this.type='date')">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="col-form-label">DH
                                                            (Interview)</label>
                                                        <input type="text" class="form-control"
                                                            ng-model="DHinterviewdate" onfocus="(this.type='date')"
                                                            onblur="(this.type='date')">
                                                    </div>
                                                    ...
                                                    <div class="form-group text-right col-md-12">
                                                        ...
                                                        <button class="btn btn-sm btn-info"
                                                            ng-click="SendRemindertoHR();"><i class="fa fa-clock-o"></i>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="form-group text-right">
                                                        ...
                                                        <button class="btn btn-sm btn-danger"
                                                            ng-click="ResetVaccination();"><i class="fa fa-times"></i>
                                                            Reset</button>
