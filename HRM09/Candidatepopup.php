                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" ng-model="CurAnnuaBasicDA"
                                                    autocomplete="off" onkeypress="return Validate(event);" readonly>
                                            </td>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" ng-model="CurMotGratuity"
                                                    autocomplete="off" onkeypress="return Validate(event);" readonly>
                                            </td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" ng-model="CurMotCanteen"
                                                    autocomplete="off" onkeypress="return Validate(event);"></td>
                                            <td><input type="text" class="form-control" ng-model="CurAnnuaCanteen"
                                                    autocomplete="off" onkeypress="return Validate(event);"></td>
...
<div class="modal fade" id="ModalCenter1s" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
...
<div class="modal fade" id="ModalApproval" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger" role="alert">
                    ...
                    <select class="form-control" ng-model="MDApproval" ng-change="GetStatusAlert(FitStatus);">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <table id="iif-editor" class="mb-2">
                        <tr>
                            <div text-angular="text-angular" name="MessageMail" ng-model="MessageMail"
                                ta-disabled='disabled' class="iif-editor" style="width:100%;overflow:auto;"></div>
                        </tr>
                    </table>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-sm btn-success" ng-click="SendNormalMail();" data-dismiss="modal"><i
...
<div class="modal fade" id="ModalCenter1Offerletter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <iframe ng-src="{{OfferletterView}}" ng-hide="OfferletterView == null || OfferletterView == '' "
...
<div class="modal fade" id="ModalCenter1Education" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header alert alert-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div id="pdfExportAppointmentorder">
                                ...
                                <div class="pdf-sipl">
                                    ...
                                    <br /><br />
                                  <div class="row">
<div class="col-md-6"><img class="mb-2" src="../assets/images/logo/logo.jpg" width="auto"
height="80" /></div>
<div class="col-lg-6">
<p class="address"><b>{{Clientname}}</b><br />
                        ...
                        <div class="card-body">
                            ...
                            <div id="pdfExportConfirmationorderHindi">
                                ...
                                <div class="pdf-sipl">
                                    <br /><br />
                                    <div class="row">
                                        <div class="col-md-6"><img src="../assets/images/logo/logo.jpg" width="130"
                                                height="50" /></div>

                                        <div class="col-md-6">
                                            <p class="address"><b>Britannia Garment Packaging Pvt
                                                    Ltd</b><br />
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a id="btnAppointmentorderEnglish" class="btn btn-info btn-nda-down2 application-down-btn"><i
                                class="fa fa-download"></i> Download</a>
                        <div class="card-body">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a id="btnOfferLetterEnglish" class="btn btn-info btn-nda-down2 application-down-btn"><i
                                class="fa fa-download"></i> Download</a>
                        <div class="card-body">
