    ...
    <table class="table table-bordered  table-sm table-striped"
        ...
        <thead>
            ...
            <tr class="tablethrow">
                ...
                <th style="width: 50px;" class="sticky-col first-col">S.No</th>


                <th class="sticky-col second-col" style="min-width:100px">ID</th>
                <th class="sticky-col third-col" style="min-width:150px">Name</th>
                <th>Dept</th>
                <th>Designation</th>
                <th>Status</th>
                <!-- <th>Category</th>  -->
        ...
        <tbody>
            <tr>
                ...
                <td colspan="2" class="sticky-col secondsearch-col"
                    style="min-width:150px"> <input type="text" class="form-control"
                        ng-model="searchPayroll.Employeeid"></td>
                <td class="sticky-col third-col"> <input type="text" class="form-control"
               ...
               >
                ...
                <a  style="padding:5px 10px;color:#3ac47d"
                                                                    ng-click="GetPayslip(e.Employeeid,e.SalMonth,e.Salyear,e.Category);"><i
                                                                        class="fa fa-download" data-toggle="modal" title="View Payslip"
                                                                        data-target="#ModalCenterPaySlip"></i>
                                                                        {{$index+1 + (currentPagePayroll - 1) * pageSizePayroll}}     </a>
                </td>


                <td class="sticky-col second-col" style="min-width:100px">{{e.Employeeid}}</td>
                <td class="sticky-col third-col"> <input class="form-control" ng-model=e.Fullname
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="6"><span>Paid Date :
                                                                                            ...
                                                                                            style="float: right;">Wage slip/with form(25B) for the month:
                                                                                            {{e.SalMonth}}&nbsp;&nbsp; {{e.Salyear}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><b>Total Wages / மொத்தம் /
                                                                                            सकल वेतन</b></td>
                                                                                    <td>{{e.BasicDA--e.HRA--e.Otherallowance_Con_SA}}</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td> Total Days / மொத்த நாட்கள்/
                                                                                        ...
                                                                                        दिन </td>
                                                                                    <td>{{e.Totaldays}}</td>
                                                                                    <td>Food & Other Deduction / பிடித்தம் / कटौती </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td><b>Performance allowance/ஊக்க தொகை/ प्रदर्शन भत्ता </b> </td>
