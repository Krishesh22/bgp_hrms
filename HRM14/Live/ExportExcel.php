...
$active->setCellValue('AC3','FOOD&OTHER');
$active->setCellValue('AD3','TDS');
$active->setCellValue('AE3','TOTAL DEDUCTION');
$active->setCellValue('AF3','NET');
$active->setCellValue('AG3','PERFORMANCE ALLOWANCE');
...
$GetState = "SELECT * FROM indsys1026employeepayrolltempmasterdetail where SalMonth='$Payrollmonth' and Salyear='$Payrollyear' AND Category='$Category' AND Clientid='$Clientid'  ORDER BY Employeeid";
  ...
  $active->setCellValue('AE'.$currentContenRow,$rows['TotalDeduction']);
  $active->setCellValue('AF'.$currentContenRow,$rows['NetWages']);
  $active->setCellValue('AG'.$currentContenRow,$rows['Performanceallowance']);
  $active->setCellValue('AH'.$currentContenRow,$Total);
  ...
  $active->setCellValue('AG'.$currentContenRow,'GRAND TOTAL');
  $active->setCellValue('AH'.$currentContenRow,$grandTotal);
