...
<th>Year</th> -->
                                            ...
                                            <dir-pagination-controls ng-show="GetPayrollList.length>10"
                                                ...
                                                boundary-links="true" class="pagination" ng-show="btnOtheruser">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive custom-table custom-table-noborder ">
                                                <table class="table table-bordered  table-sm table-striped">
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category=='Category 3'">
                                                        <td colspan="35" style="text-align:right;font-weight:bold">
                                                            Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category!='Category 3'">
                                                        <td colspan="33" style="text-align:right;font-weight:bold">
                                                            Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
                                                        <td style="text-align:right;font-weight:bold">{{GrandTotal}}
                                            ...
                                            <dir-pagination-controls ng-show="GetPayrollList.length>10"
                                                pagination-id="PayrollGridAdmin" max-size="3" direction-links="true"
                                                boundary-links="true" class="pagination" ng-show="btnAdmin">
                                            </dir-pagination-controls>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive custom-table custom-table-noborder ">
                                                ...
                                                <table class="table table-bordered  table-sm table-striped"
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category!='Category 3'">
                                                        <td colspan="32" style="text-align:right;font-weight:bold">
                                                            Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
                                                        <td style="text-align:right;font-weight:bold">{{GrandTotal}}
