 ...
 if(mysqli_fetch_row($resultExists01))
  {
    ...
    $updatefunction = CallEmppdatepayroll($conn,$Clientid,$user_id,$date, $Employeeid,$Payrollmonth, $Payrollyear,$Workeddays, $Leavedays,$Salary_Advance, $FoodDeduction,$TDS,$Category,$Working_Days,$Nationalholiday02, $CasualLeave, $Basic,$HR_Allowance,$Other_Allowance , $OT_HRS, $DailyAllowanance,$Performanceallowance);
