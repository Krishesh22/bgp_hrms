...
<tr>
<td colspan="11" align="center"> <h3>BRITANNIA LABELS INDIA PVT LTD</h3>Attendance Report</td>
...
<td style="width:50px !important;" class="title" align="center">
Reg Hrs
</td>
<td style="width:75px !important;" class="title" align="center">
Act Hrs
...
<td style="width:40px !important;" class="title" align="center">
LOP
</td> 
...
<td style="width:100px !important;" class="title" align="center">
Remarks
</td>
</tr>
...
<?php
   ...
   $sql = "SELECT  Count(AttenStatus) from vwattendenceclosestatus where Attendencedate>='$fdaymonth' and Attendencedate <='$ldaymonth' and Employeeid = '$emp_id' and AttenStatus='P' and Empattendencestatus='Close' AND Clientid='$Clientid'";
    ...
    $Workeddays = $CountPresentDays+$HalfDaycount+$CountOD+$SLHalfday+$CLHalfday;
...
if($dateofjoingdays<=$abs_diff)
{
 //Echo "$emp_id<br/>";
  ...
  $sqlHDND = "SELECT Count(*) as total from vwholidaymaster where Month ='$month_num' and Year = '$year_num' and Dayname!='Sunday' AND Clientid ='$Clientid'  AND DATE(Holidaydate) >='$date_of_joining' ";
