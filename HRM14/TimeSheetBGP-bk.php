...
<!--         <p style="font-size:0.7rem;margin-bottom:1px;">
          4LABEL ARCADE' 476/1B1A, Jothi Nagar test,
    ...
    <th class="leaveatt"></th>
      ...
      $x=2;
       foreach ($period as $dt) {
        ...
        echo '<th class="leaveatt" >' . $day . '<br/>' . $dayOfWeeknew . '</th>';    
}?>
...
//echo $sql_perform_att;exit;
   ...
   echo '<td colspan='.$x.'>'.$sno. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paycode: '.$emp_id.' &nbsp;&nbsp;&nbsp;&nbsp;Name:'.$Firstname.'    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Designation:'.$Designation.'  </td>';
...
<?php
    ...
    echo "<tr>";
    echo"<td><p>In </p><p>Out </p><p>Work</p><p>OT </p><p>Late </p><p>Status</p> </td>";
...
echo '<td style="text-align: center;"><p>P:'.$Workeddays.'</p><p>A:'.$TotalAbsent.'</p><p>WO:'.$totsundays.'</p><p>NH:'.$Nationalholiday.'</p><p>CL:'.$TotalCLcount.'</p><p>SL:'.$TotalSLcount.'</p><p>TOT:'.$Totworked.'</p></td>';
