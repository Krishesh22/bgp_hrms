...
<body>
  ...
  <div id="pdfExport">
    ...
    <div class="container-fluid">
      ...
      <p>' .date("H:i", strtotime($Intime))  . '</p>
      <p>' . date("H:i", strtotime($Outtime)) . '</p>
      <p>' . $Workinghours . '</p>
      <p>' . date("H:i", strtotime($OTIntime)) . '</p>
      <p>' . date("H:i", strtotime($OTOuttime)) . '</p>
      <p>' . $ActualOt_HRS . '</p>
      <p>' . $Lophrs . '</p>
      <p>' . $AttenStatus . '</p></td>';
                  } else {

                    echo '<td> <p>' .date("H:i", strtotime($Intime))  .'</p>
    <p>' . date("H:i", strtotime($Outtime)) . '</p>
    <p>' . $Workinghours . '</p>
    <p>' . date("H:i", strtotime($OTIntime)). '</p>
      <p>' . date("H:i", strtotime($OTOuttime)) . '</p>
