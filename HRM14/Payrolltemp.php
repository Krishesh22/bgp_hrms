...
if ($MethodGet == 'FetchBulk') {
    try {
        ...
        while ($row = mysqli_fetch_array($logempall)) {
            ...
            $GetState = "SELECT * FROM indsys1017employeemaster where Employeeid='$Employeeid'   AND Gross_Salary >30000 AND  (BackgroundVerification='No' OR BackgroundVerification is null)   ORDER BY Employeeid";
