                                    ...
                                    <div class="" style="padding:25px 0 10px 25px">
                                        ...
                                        <div class="float-right mt-2" style="margin-right: 15px;">
                                            ...
                                            <a class="btn btn-warning btn-sm" href="Exportholidaypay.php"
                                                ...
                                                Excel Download</a>
                                        <a class="btn btn-warning btn-sm" href="Legalreport.php" target="_blank"
                                                ng-click="GETREPORT()"><i class="fa fa-download"></i>
                                                Legal Pdf</a>
                                                ...
                                                <table class="table table-bordered  table-sm table-striped">
                                                    <thead>
                                                        <tr class="tableheadrow" ng-show="Category!='Category 3'">
                                                            ...
                                                            <td colspan="5" class="tabletotalrow">Advance&Deduction</td>
...
<th>Year</th> -->
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ...
                                                        <td colspan="37" style="text-align:right">Total</td>
                                                        <!-- <td>{{NetWages}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive custom-table custom-table-noborder ">
                                                <table class="table table-bordered  table-sm table-striped">
                                                    ...
                                                    <tr style='background-color:yellow'
                                                        ng-show="Category=='Category 3'">
                                                        <td colspan="37" style="text-align:right;font-weight:bold">
                                                            Total&nbsp;&nbsp;</td>
                                                        <!-- <td>{{NetWages}}</td>
                                                        <td>{{Performanceallowance}}</td> -->
