...
<div class="col-md-12">
  ...
  $thead .= '<th class="leaveatt" >' . $day . '<br/>' . $dayOfWeeknew . '</th>';    
  }?>
...
$tdata .= "<tr>";
$tdata .=  '<td colspan='.$x.'>'.$sno. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paycode: '.$emp_id.' &nbsp;&nbsp;&nbsp;&nbsp;Name:'.$Firstname.'    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Designation:'.$Designation.'  </td>';
$tdata .=  "</tr>";
?>
<?php
    ...
    $tdata .=  "<tr>";
    $tdata .= "<td><p>In </p><p>Out </p><p>Work</p><p>OT In</p><p>OT Out</p><p>OT Hrs </p><p>Late </p><p>Status</p><p></p> </td>";
    ...
    $dt3 = strtolower($dt2);
    if ($dt3 == "sunday") {    
      $tdata .=  '<td style="background-color:#fab9be;">
      <p>'.$Intime.'</p>
      <p>'.$Outtime.'</p>
      <p>'.$Workinghours.'</p>
      <p>'.$OTIntime.'</p>
...
$tdata .= '<td style="text-align: center;"><p>P:'.$Workeddays.'</p><p>A:'.$TotalAbsent.'</p><p>WO:'.$totsundays.'</p><p>NH:'.$Nationalholiday.'</p><p>CL:'.$TotalCLcount.'</p><p>SL:'.$TotalSLcount.'</p><p>TOT:'.$Totworked.'</p><p></p></td>';
...
<table border="2" width="100%"  height="90%" cellpadding="2" cellspacing="2" style="font-size:9px">
    <thead>
    <tr class="text-center">
    <td colspan="50">       
    <?php echo "<h5>$Clientname</h6><p style='font-size:0.7rem;margin-bottom:1px;'>$AddressLine1, $AddressLine2<br/>$AddressLine3, $Place-$Zipcode, $Country.</p>";?>
    <p style="font-size:0.7rem;margin-bottom: 1px;"><b><?php echo"$month -$year";?></b>  </p>
      </td>
    </tr>  
    <tr>
